...
export const ASSIGNMENT_SELECT_WATCH =
  "id, is_completed, progress_percent, last_position, prevent_skip, watched_intervals, videos(id, title, video_id)";

/** watched_intervals 컬럼이 없을 때 시청 페이지 조회용 (마이그레이션 미적용 DB 호환) */
